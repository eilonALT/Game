...
public class MainTrain {
	...
	public static void testLRU() {
		...
		if (!lru.remove().equals("b"))
			...
			System.out.println("LRU implementation is correct (+10)");
		}
	}
	...
	public static void testLFU() {
		...
		if (!lfu.remove().equals("c"))
			...
			System.out.println("LFU implementation is correct (+10)");
		}
	}
	...
	public static void testBloomFilter() {
		...
		if (!bf.toString().equals(
			...
			System.out.println("bloom filter bit vector is correct (+10)");
		...
		if (!found)
			...
			System.out.println("bloom filter contains all words (+15)");
		found = false;
		...
		if (found)
			...
			System.out.println("bloom filter does not contain words that should not exist (+15)");
